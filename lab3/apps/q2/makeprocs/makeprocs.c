...
int main (int argc, char *argv[]){
    ...
    process_create(PRODUCER_FILENAME_S, 0, 0, sem_procs_completed_str, num_S2_init_str, mbox_S2_str, NULL);
    ...
    process_create(REACT_FILENAME_3, 0, 0, sem_procs_completed_str,mbox_S_str, mbox_O2_str, mbox_SO4_str, numReact3_str, NULL);
    ...
    Printf("%d CO's left over. ", num_CO_init - 4*numReact2);
    Printf("%d O2's left over. ", (2*numReact2) - (2*numReact3));
    Printf("%d C2's created. ", (2*numReact2));
